...
function modal(triggerSelect, modalSelector, modalTimerId) {
    // Modal

    const modalTrigger = document.querySelectorAll(triggerSelect),
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({counteiner, slide, nextArrow, prevArrow, totlaCounter, currentCounter, wrapper, field}) {
    // Slider
    ...
    const slides = document.querySelectorAll(slide),
        slider = document.querySelector(counteiner),
